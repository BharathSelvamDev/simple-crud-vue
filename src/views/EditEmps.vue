...
export default {
  ...
  mounted() {
    axios.get("https://vue-api-boot.herokuapp.com/get/" + this.ids).then((response) => {
      this.details = response.data;
      this.name = this.details.name;
      this.city = this.details.city;
      this.phone = this.details.phoneNo;
      this.hobby = this.details.hobby;
    });
  },
  methods: {
    GoToAdmin() {
    ...
    UpdateDetails() {
      axios
        .post(
          "https://vue-api-boot.herokuapp.com/update/" +
            this.ids +
            "/" +
            this.name +
            "/" +
